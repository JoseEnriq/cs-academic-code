...
// Função para preencher a pilha com números primos
void preencherPilha(stack<int>& pilha) 
{
    int count = 0;
    int num = 2; // Inicia a busca de números primos a partir de 2

    while (count < 1000) // Enquanto a pilha não estiver cheia
    { 
        if (verificaPrimo(num)) // Se o número atual é primo
        { 
